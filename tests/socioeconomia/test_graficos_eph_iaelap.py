...
from socioeconomia.graficos_eph_iaelap import (
    _etiqueta_rango_hueco,
    _indice_primer_trimestre_desde,
    _indices_huecos_no_publicados,
...
class TestIndicesHuecosNoPublicados:
    def test_sin_hueco_devuelve_lista_vacia(self):
        filas = _filas([(2011, 1), (2011, 2), (2011, 3)])
        assert _indices_huecos_no_publicados(filas) == []
    ...
    def test_detecta_hueco_2015t3_2016t1(self):
        ...
        assert _indices_huecos_no_publicados(filas) == [(1, 2)]

    def test_devuelve_todos_los_huecos_si_hay_varios_en_orden(self):
        filas = _filas([(2011, 1), (2011, 3), (2012, 1), (2012, 4)])
        assert _indices_huecos_no_publicados(filas) == [(0, 1), (1, 2), (2, 3)]


class TestEtiquetaRangoHueco:
    def test_un_solo_trimestre_faltante(self):
        assert _etiqueta_rango_hueco((2007, 2), (2007, 4)) == "2007T3"

    def test_varios_trimestres_faltantes_cruzando_anio(self):
        assert _etiqueta_rango_hueco((2015, 2), (2016, 2)) == "2015T3-2016T1"
