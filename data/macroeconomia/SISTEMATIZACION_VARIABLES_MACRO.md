...
decisiones, catálogo variable por variable) está en
`docs/auditoria_interna/plan_macroeconomia.md` — documento de trabajo
interno, no versionado (`.gitignore`d); las referencias de este archivo
a secciones puntuales de ese plan son válidas para quien tenga el
checkout local, no para un clone del repo público.
...
mes (ver "Split a catálogo anual" en `docs/auditoria_interna/plan_macroeconomia.md`; motivo
...
Ver `docs/auditoria_interna/plan_macroeconomia.md` ("Rediseño posterior") para el detalle de la
...
antes (ver `docs/auditoria_interna/plan_macroeconomia.md` §3 para el porqué de cada corte).
...
diseño original, ver `docs/auditoria_interna/plan_macroeconomia.md` §1.
...
esperado. Corregido en `docs/auditoria_interna/plan_macroeconomia.md` §3.7 y en
...
Heredado de `docs/auditoria_interna/plan_macroeconomia.md` §7, con la auditoría ya corrida (§3):
...
decidido en `docs/auditoria_interna/plan_macroeconomia.md` §5 punto 5.
