...
|---|---|---|
| Macroeconomía | Series nacionales 2001-2025 (IPC, tipo de cambio, deuda, PBI, mercado laboral), grano exclusivamente nacional, sin `circuito_id` ni localidad — nunca cruzada espacialmente con lo electoral, sólo por fecha | `data/macroeconomia/SISTEMATIZACION_VARIABLES_MACRO.md` (evaluación de fuentes en `docs/auditoria_interna/plan_macroeconomia.md`, interno) |
...
- **v8.2.0** (`70b0646`): `docs/` reorganizado en `docs/especificaciones/`
  (9 archivos entonces, 6 hoy — 3 planes internos se sacaron de ahí
  después, ver más abajo); quinta pestaña interactiva,
